...
public class P1_menu
{
	...
	
	{
		...
		{
			for( ptr2=ptr1.next;ptr1!=null; ptr2=ptr2.next)
			{
	...
	public	static void insert_End( link node)
		...
		public static void insert_val(link node )
		{
			...
			System.out.println(" enter the value of the current node ");
			curr.info=sc.nextInt();
			System.out.println(" enter the value after which ypu want to put the cureent value ");
			int val=sc.nextInt();
	...
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			System.out.println(" 6) insertion of new node after a given node value  ");
